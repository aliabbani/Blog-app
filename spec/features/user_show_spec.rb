...
RSpec.describe 'User Index features', type: :feature do
    before(:each) do
        ...
        @post1 = @alli1.posts.create!(title: 'Cats and Dogs', text: 'Lorem ipsum dolor sit amet1.', comments_counter: 0, likes_counter: 0)
        @post2 = @alli1.posts.create!(title: 'Food', text: 'Lorem ipsum dolor sit amet2.', comments_counter: 0, likes_counter: 0)
        @post3 = @alli1.posts.create!(title: 'Cars', text: 'Lorem ipsum dolor sit amet3.', comments_counter: 0, likes_counter: 0)
